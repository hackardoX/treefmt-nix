...
let
  ...
  schemaSha256s = {
    ...
    "2.2.2" = "sha256:15hwjj1bmsp6pa9rmj4l73n247g4cssh0fy443bk1pafcz3ns18j";
  };
  ...
  biomeVersion = if (pkgs.biome.version != null && builtins.elem pkgs.biome.version allVersions)
    ...
    else builtins.elemAt (builtins.sort (v: w: builtins.compareVersion v w) allVersions) (builtins.length allVersions - 1);
